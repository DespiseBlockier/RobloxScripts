...
local MyRepo = "https://raw.githubusercontent.com/DespiseBlockier/RobloxScripts/refs/heads/main/BagrogiModules"
local BagrogiSounds = loadstring(game:HttpGet(MyRepo .. "/BagrogiSounds.lua"))()
