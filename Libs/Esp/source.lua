...
if not getgenv().DBlockier or getgenv().DBlockier.WallHack then return end
...
local Environment = getgenv().DBlockier.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().DBlockier.WallHack.Functions = nil
	getgenv().DBlockier.WallHack = nil
